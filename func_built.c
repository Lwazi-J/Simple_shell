...
/**
 * cd_shell - Changes the current directory of the simple_shell process.
...
int cd_shell(char **args, char __attribute__((__unused__)) **front)
{
	...
	dir_info[0] = "OLDPWD";
	dir_info[1] = oldpwd;
	if (set_env(dir_info, dir_info) == -1)
		return (-1);
...
/**
 * help_shell - Displays information about simple_shell builtin commands.
 * @args: An array of arguments.
